...
class DrawActorsAction(Action):
    ...
    def execute(self, cast, script):
        ...
        cycle1 = cast.get_first_actor("cycles") # gets the first actor from the 'cycles' group. 'cycles' is passed to the 'get_first_actor(group)' method found in Cast() class.
        cycle2 = cast.get_second_actor("cycles") # gets the second actor from the 'cycles' group. 'cycles' is passed to the 'get_second_actor(group)' method found in Cast() class.
        ...
        cycle1.grow_tail(cast, 1)
        cycle2.grow_tail(cast, 1)
